 ...
 * @author edgar004
 */
public class ConsultasPrestamosSaldado extends javax.swing.JFrame {

    /**
     * Creates new form ConsultasPrestamosSaldado
     */
    public ConsultasPrestamosSaldado() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultasPrestamosSaldado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultasPrestamosSaldado().setVisible(true);
            }
        });
    }
